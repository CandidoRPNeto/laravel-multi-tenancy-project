...
<div x-data="dashboard">
    <div class="flex flex-col min-h-[calc(100vh-100px)] justify-between mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex overflow-x-auto flex-1 py-4 w-full" x-ref="vegalitecontainer">
            <div id="vis"></div>
        </div>

        <div class="flex flex-col items-start space-y-2 w-full">
            <textarea wire:model.live.debounce.500ms="question"
            ...
            <div class="flex justify-between w-full">
                <x-primary-button class="inline-flex flex-row gap-2 items-center" @click="generateReport()">
                    Gerar relatorio
                    <svg x-show="loading" class="-ml-1 w-5 h-5 text-white animate-spin"
